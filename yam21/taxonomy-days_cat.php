    ...
    <div class="days_content_cat_wrap2">
      ...
      <ul class="days_content_cat_list">
        ...
        <?php
          ...
          $terms = array('staff', 'partner', 'ob_og'); // List of terms to check against

          foreach ($terms as $term) {
              $class = ($selected_term_slug === $term) ? 'is-active' : '';
              echo '<li class="days_content_cat_item copperplate ' . $class . '">';
              echo '<a href="' . home_url('/') . 'days_cat/' . $term . '#days_list">FROM ' . strtoupper(str_replace('_', ' ', $term)) . '</a>';
              echo '</li>';
          }
          ?>
      </ul>
