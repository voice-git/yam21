...
私たちが賛同し共同で進めているプロジェクトメンバーの方々とお話しし、対談形式でご紹介させていただきます。
    ...
    <div class="sdgs_page_cat_title"><div class="sdgs_page_cat_title_top">NEW GOALS</div>
    <div class="sdgs_page_cat_title_bot">これから取組む活動と項目</div></div>
...
<?php endif; ?>
    ...
    <div class="mt100 sdgs_page_foot_link_width pt50">
        <div uk-grid class="uk-child-width-1-2@s uk-child-width-1-1">
            <div>
                <a href="/sdgs_cat/new_goals" class="sdgs_page_foot_link sdgs_page_foot_link_01 sdgs_page_foot_link_current">
                    <div class="sdgs_page_foot_link_title">NEW GOALS</div>
                    <div class="sdgs_page_foot_link_txt">これから取組む活動と項目</div>
                    </a>
            </div>
            <div>
                <a href="/sdgs_cat/archives" class="sdgs_page_foot_link sdgs_page_foot_link_02">
